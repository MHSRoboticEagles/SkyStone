...
public class MasterOdo extends LinearOpMode {
    ...
    private static final int[] modesStep = new int[]{0, 1, 2, 3, 4, 5};
    private static final String[] modeStepName = new String[]{"Destination", "Top Speed", "Strategy", "Wait", "Heading", "Action"};
